...
export const ui = {
    ...
    cardInteractive: "transition-[border-color,box-shadow] duration-150 hover:border-ui-primary/30 hover:shadow-ui-elevated",
    ...
    listRow: "flex items-center min-h-list-row p-4 cursor-pointer rounded-ui-md border border-transparent bg-ui-list transition-colors duration-150 hover:bg-ui-list-hover hover:border-ui-list-border-hover",
