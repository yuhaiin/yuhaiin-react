...
export const ui = {
    ...
    cardInteractive: "transition-[border-color,box-shadow,transform] duration-300 hover:-translate-y-0.5 hover:border-ui-primary/30 hover:shadow-ui-elevated",
    field: "block w-full h-field px-3.5 text-[0.9375rem] font-normal leading-normal text-ui-fg bg-ui-bg border border-ui-border rounded-ui-md shadow-inner-subtle appearance-none outline-none transition-[border-color,box-shadow,background-color] duration-150",
    ...
    listRow: "flex items-center min-h-list-row p-4 cursor-pointer rounded-ui-lg border border-transparent bg-ui-list transition-[background-color,border-color,box-shadow] duration-200 hover:bg-ui-list-hover hover:border-ui-list-border-hover hover:shadow-sm",
    sectionLabel: "block mb-2 text-[11px] font-bold leading-[1.2] uppercase tracking-[0.06em] text-ui-muted whitespace-nowrap overflow-hidden text-ellipsis cursor-pointer",
    ...
    softPanel: "rounded-ui-lg bg-ui-surface-muted border border-ui-border shadow-[0_4px_14px_-12px_rgba(50,73,110,0.4)]",
