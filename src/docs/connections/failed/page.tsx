            ...
            <div className="flex w-full flex-col md:flex-row items-start md:items-center justify-between gap-3">
                ...
                <div className="flex items-center flex-grow overflow-hidden gap-3 w-full w-md-auto">
                    ...
                    <div className="flex flex-col overflow-hidden" style={{ minWidth: 0 }}>
                        <span className="font-bold truncate text-base text-danger text-opacity-75">{data.host}</span>
                ...
                <div className="flex flex-wrap gap-2 items-center shrink-0">
                    ...
                    <div className="text-gray-500 opacity-25 ml-2 hidden md:block"><ChevronRight /></div>
                </div>
            </div>
        </>
    );
        ...
        <Modal open={show} onOpenChange={(open) => !open && onClose()}>
            <ModalContent>
                <ModalHeader closeButton>
                    <ModalTitle className="font-bold text-danger">Failure Details</ModalTitle>
                </ModalHeader>
                <ModalBody>
                    <div>
                        <DataList>
            ...
            <div className="flex flex-wrap justify-between items-end mb-4 gap-3">
                <div>
                    ...
                    <div className="text-gray-500 flex items-center small">
                        <Bug className="text-danger mr-2" />
                        ...
                        <DropdownContent align="end" className="p-3" style={{ minWidth: '220px' }}>
                            ...
                            <div>
                                ...
                                <ToggleGroup type="single" value={sortBy} onValueChange={(v) => v && setSortBy(v)} className="w-full whitespace-nowrap">
                                    <ToggleItem value="Time" className="flex-grow px-3">Time</ToggleItem>
                                    <ToggleItem value="Host" className="flex-grow px-3">Host</ToggleItem>
                                    <ToggleItem value="Count" className="flex-grow px-3">Count</ToggleItem>
                                </ToggleGroup>
                            </div>
                        </DropdownContent>
                    </Dropdown>
