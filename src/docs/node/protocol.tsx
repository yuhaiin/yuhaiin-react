        ...
        return <>
            ...
            <div className="mb-3">
                <div className="flex justify-between items-center mb-2 px-1">
                    ...
                    <small className="text-gray-500">{value.protocols.length} steps</small>
                </div>
                                ...
                                <AccordionItem value={`item-${i}`} key={i}>
                                    <AccordionTrigger>
                                        <div className="flex items-center gap-2">
                                            <span className="bg-primary bg-opacity-10 text-[var(--bs-primary)] rounded-full px-2 text-[0.7rem] font-bold">{i + 1}</span>
                                    ...
                                    <AccordionContent>
                                        <div className="p-1">
                                            ...
                                            {editable && (
                                                <div className="flex justify-end gap-2 mt-3 pt-3 border-t border-[var(--bs-border-color)]">
                ...
                {editable && (
                    <div className="bg-[var(--bs-tertiary-bg)] p-3 rounded-lg flex items-end gap-3 flex-wrap sm:flex-nowrap">
                        <div className="flex-grow">
                            <label className="block mb-2 text-sm font-bold opacity-75">New Protocol Step</label>
                            <Select
                                value={newProtocol}
...
const NetworkSplit: FC<Props<network_split>> = ({ value, onChange, editable = true }) => {
    ...
    return <>
        <div className="mb-3">
            <label className="block mb-2 text-sm font-bold opacity-75">TCP Protocol</label>
        ...
        <div className="mb-3">
            <label className="block mb-2 text-sm font-bold opacity-75">UDP Protocol</label>
