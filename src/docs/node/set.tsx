                ...
                {value.nodes.map((x, i) => (
                    <div key={i}
                        className={clsx(
                            ...
                            editable && "cursor-pointer hover:bg-gray-200 dark:hover:bg-white/10"
                        )}
                        onClick={() => {
                            if (!editable) return
                            setModalData({
                    ...
                    >
                        <div className="truncate mr-3">
                            ...
                            <br />
                            <small className="text-gray-500 dark:text-gray-400 opacity-50 font-mono text-[0.7rem]">{x}</small>
                        </div>
