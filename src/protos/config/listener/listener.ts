...
export interface config_ServersEntry {
  key: string;
...
export const config = {
  encode(message: config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.servers).forEach(([key, value]) => {
      config_ServersEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).ldelim();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 5:
          ...
          const entry5 = config_ServersEntry.decode(reader, reader.uint32());
...
function createBaseconfig_ServersEntry(): config_ServersEntry {
  return { key: "", value: undefined };
}

export const config_ServersEntry = {
  encode(message: config_ServersEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): config_ServersEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseconfig_ServersEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): config_ServersEntry {
    return {
  ...
  toJSON(message: config_ServersEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<config_ServersEntry>, I>>(base?: I): config_ServersEntry {
    return config_ServersEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<config_ServersEntry>, I>>(object: I): config_ServersEntry {
    const message = createBaseconfig_ServersEntry();
