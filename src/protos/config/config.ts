...
import { config } from "./bypass/bypass";
import { config as config1 } from "./dns/dns";
import { config as config2 } from "./listener/listener";
...
export interface setting {
  ...
  bypass: config | undefined;
  dns: config1 | undefined;
  server: config2 | undefined;
...
export const setting = {
  encode(message: setting, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.bypass !== undefined) {
      config.encode(message.bypass, writer.uint32(18).fork()).ldelim();
    }
    if (message.dns !== undefined) {
      config1.encode(message.dns, writer.uint32(34).fork()).ldelim();
    }
    if (message.server !== undefined) {
      config2.encode(message.server, writer.uint32(42).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.bypass = config.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.dns = config1.decode(reader, reader.uint32());
          continue;
        case 5:
          if (tag !== 42) {
            break;
          ...
          message.server = config2.decode(reader, reader.uint32());
          continue;
        case 8:
          if (tag !== 66) {
            break;
  ...
  fromJSON(object: any): setting {
    return {
      ...
      bypass: isSet(object.bypass) ? config.fromJSON(object.bypass) : undefined,
      dns: isSet(object.dns) ? config1.fromJSON(object.dns) : undefined,
      server: isSet(object.server) ? config2.fromJSON(object.server) : undefined,
  ...
  toJSON(message: setting): unknown {
    ...
    if (message.bypass !== undefined) {
      obj.bypass = config.toJSON(message.bypass);
    }
    if (message.dns !== undefined) {
      obj.dns = config1.toJSON(message.dns);
    }
    if (message.server !== undefined) {
      obj.server = config2.toJSON(message.server);
    }
    if (message.logcat !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<setting>, I>>(object: I): setting {
    ...
    message.bypass = (object.bypass !== undefined && object.bypass !== null)
      ? config.fromPartial(object.bypass)
      : undefined;
    message.dns = (object.dns !== undefined && object.dns !== null) ? config1.fromPartial(object.dns) : undefined;
    message.server = (object.server !== undefined && object.server !== null)
      ? config2.fromPartial(object.server)
      : undefined;
