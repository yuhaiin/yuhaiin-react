...
export const config = {
  encode(message: config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.hosts).forEach(([key, value]) => {
      config_HostsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).ldelim();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          const entry8 = config_HostsEntry.decode(reader, reader.uint32());
...
export const config_HostsEntry = {
  encode(message: config_HostsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): config_HostsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<config_HostsEntry>, I>>(base?: I): config_HostsEntry {
    return config_HostsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<config_HostsEntry>, I>>(object: I): config_HostsEntry {
    const message = createBaseconfig_HostsEntry();
