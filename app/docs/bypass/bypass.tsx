        ...
        <>
            <Card className="mb-3">
                <Card.Body>
                    ...
                    <SettingTypeSelect label='UDP' type={modeSchema} value={bypass.udp} onChange={(v) => onChange({ ...bypass, udp: v })} />
                </Card.Body>
            </Card>
            ...
            <Card className="mb-3">
                <Card.Body>
                    ...
                    <SettingSelect value={bypass.proxyResolver ? bypass.proxyResolver : "proxy"} values={resolverList()} label='Proxy Resolver' onChange={(v) => onChange({ ...bypass, proxyResolver: v })} />
                </Card.Body>
            </Card>
