...
export const file_statistic_config: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_go_features, file_config_bypass]);
...
export type connection = Message<"yuhaiin.statistic.connection"> & {
  ...
  /**
   * @generated from field: string geo = 31;
   */
  geo: string;

  /**
   * @generated from field: string outbound_geo = 32 [json_name = "outbound_geo"];
   */
  outboundGeo: string;

  /**
   * @generated from field: repeated string lists = 33;
   */
  lists: string[];
};
